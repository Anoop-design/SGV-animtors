...
import { AnimationSettings, AnimationPreset, ParsedPath, EasingType, StaggerMode, DEFAULT_PRESETS, GlobalTransform, AnimationDirection, PathTransform, TransformState, DEFAULT_TRANSFORM_STATE, DEFAULT_PATH_TRANSFORM } from '../types';
                                            ...
                                            <div className="controls-field">
                                                ...
                                                <div style={{ flex: 1 }}>
                                                    <Dropdown
                                                        ...
                                                        value={settings.interactionTrigger || 'none'}
                                                        onChange={(val) => updateSetting('interactionTrigger', val as any)}
                                                    />
                                                </div>
                                            </div>
                                        </div>
