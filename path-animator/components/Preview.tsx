              ...
              {parsedSVG.paths.map((path, index) => {
                ...
                return (
                  <React.Fragment key={path.id}>
                    ...
                    <g
                      style={{
                        // Transform animation CSS variables - use effective transform
                        // @ts-ignore
                        '--tx': `${effectiveTransform.x}px`,
                        // @ts-ignore
                        '--ty': `${effectiveTransform.y}px`,
                        // @ts-ignore
                        '--ts': effectiveTransform.scale,
                        // @ts-ignore
                        '--tr': `${effectiveTransform.rotate}deg`,
                        // @ts-ignore
                        '--to': effectiveTransform.opacity,
                        // @ts-ignore
                        '--path-delay': `${delay}s`,
                        // @ts-ignore
                        '--anim-direction': settings.animationDirection === 'in' ? 'reverse' : 'normal',
                        ...
                        animationDirection: settings.animationDirection === 'in' ? 'reverse' : 'normal',
