...
export const Header: React.FC<HeaderProps> = ({
  ...
  const exportOptions = [
    ...
    { divider: true },
    { type: 'react' as ExportType, label: 'Copy React', desc: 'React component', icon: ReactLogo },
    { type: 'framer-motion' as ExportType, label: 'Copy Framer Motion', desc: 'motion.path animations', icon: FramerMotionLogo },
                ...
                {exportOptions.map((option, index) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        if ('download' in option && option.download) {
                          onDownload();
                        } else if (option.type) {
